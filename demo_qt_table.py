...
if __name__ == '__main__':
    ...
    # database.insert_record(City(id=0, postal_code=8300, city_name='Odder'))
    # database.insert_record(City(id=1, postal_code=8660, city_name='Skanderborg'))
    # database.insert_record(City(id=2, postal_code=2500, city_name='Valby'))
